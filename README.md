...
These skills must not author public-facing marketing copy or generative key
art. The agent asks the developer for the exact words that will reach players,
press, creators, or platform reviewers. It may organize approved words,
transcribe human speech, insert verified factual fields into a human-written
template, and flag errors, but it must not quietly rewrite the developer into
an artificial marketing voice.
...
There is one narrow exception for non-promotional privacy, consent, and
